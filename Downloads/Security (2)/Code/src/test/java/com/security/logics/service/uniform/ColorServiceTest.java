...
public class ColorServiceTest extends AbstractTest {
    ...
    @org.junit.Test
    public void getColorByValidId() throws ColorNotFoundException {
        //Arrange
        ColorDTO dto = new ColorDTO();
        dto.setColorId(1L);
        dto.setColorName("Pink");
    ...
    @org.junit.Test
    public void getColorByInValidId() throws ColorNotFoundException {
        //Arrange
        ColorDTO dto = new ColorDTO();
        dto.setColorId(1L);
        dto.setColorName("Pink");
    ...
    @org.junit.Test
    public void updateColor() throws ColorNotFoundException {
        //Arrange
        ColorDTO dto = new ColorDTO();
        dto.setColorId(1L);
        dto.setColorName("Pink");
    ...
    @Test
    public void deleteColor() throws ColorNotFoundException {
        //Arrange
        ColorDTO dto = new ColorDTO();
        dto.setColorId(1L);
        dto.setColorName("Pink");
