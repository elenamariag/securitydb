...
public class UniformServiceTest extends AbstractTest {
    ...
    @org.junit.Test
    public void getUniformByValidId() throws UniformNotFoundException {
        //Arrange
        UniformDTO dto = new UniformDTO();
        dto.setUniformId(1L);
        dto.setShirt(new ShirtDTO());
    ...
    @org.junit.Test
    public void getUniformByInValidId() throws UniformNotFoundException {
        //Arrange
        UniformDTO dto = new UniformDTO();
        dto.setUniformId(1L);
        dto.setShirt(new ShirtDTO());
    ...
    @org.junit.Test
    public void updateUniform() throws UniformNotFoundException {
        //Arrange
        UniformDTO dto = new UniformDTO();
        dto.setUniformId(1L);
        dto.setShirt(new ShirtDTO());
    ...
    @Test
    public void deleteUniform() throws UniformNotFoundException {
        //Arrange
        UniformDTO dto = new UniformDTO();
        dto.setUniformId(1L);
        dto.setShirt(new ShirtDTO());
