...
public class SecurityBadgeServiceTest extends AbstractTest {
    ...
    @org.junit.Test
    public void getSecurityBadgeByValidId() throws SecurityBadgeNotFoundException {
        //Arrange
        SecurityBadgeDTO dto = new SecurityBadgeDTO();
        dto.setSecurityBadgeId(1L);
        dto.setName("testBadgeName");
    ...
    @org.junit.Test
    public void getSecurityBadgeByInValidId() throws SecurityBadgeNotFoundException {
        //Arrange
        SecurityBadgeDTO dto = new SecurityBadgeDTO();
        dto.setSecurityBadgeId(1L);
        dto.setName("testBadgeName");
