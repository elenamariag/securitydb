...
public class ShirtServiceTest extends AbstractTest {
    ...
    @org.junit.Test
    public void saveShirt() throws ColorNotFoundException, SizeNotFoundException {
        //Arrange
    ...
    @org.junit.Test
    public void getShirtByValidId() throws ShirtNotFoundException {
        //Arrange
        ShirtDTO dto = new ShirtDTO();
        dto.setShirtId(1L);
        dto.setShirtName("Pink");
    ...
    @org.junit.Test
    public void getShirtByInValidId() throws ShirtNotFoundException {
        //Arrange
        ShirtDTO dto = new ShirtDTO();
        dto.setShirtId(1L);
        dto.setShirtName("Pink");
    ...
    @org.junit.Test
    public void updateShirt() throws ShirtNotFoundException {
        //Arrange
        ColorDTO color = new ColorDTO();
        color.setColorName("Grey");
        SizeDTO sizeDTO = new SizeDTO();
    ...
    @Test
    public void deleteShirt() throws ShirtNotFoundException {
        //Arrange
        ShirtDTO dto = new ShirtDTO();
        dto.setShirtId(1L);
        dto.setShirtName("Pink");
