...
public class TieServiceTest extends AbstractTest {
    ...
    @org.junit.Test
    public void getTieByValidId() throws TieNotFoundException {
        //Arrange
        TieDTO dto = new TieDTO();
        dto.setTieId(1L);
        dto.setName("Bow");
    ...
    @org.junit.Test
    public void getTieByInValidId() throws TieNotFoundException {
        //Arrange
        TieDTO dto = new TieDTO();
        dto.setTieId(1L);
        dto.setName("Bow");
    ...
    @org.junit.Test
    public void updateTie() throws TieNotFoundException {
        //Arrange
        ColorEntity color = new ColorEntity();
        color.setColorName("Grey");
        TieDTO dto = new TieDTO();
    ...
    @Test
    public void deleteTie() throws TieNotFoundException {
        //Arrange
        TieDTO dto = new TieDTO();
        dto.setTieId(1L);
        dto.setName("Bow");
